...
class Tests {
    ...
    @Tag("Normal")
    fun dateStrToDigit() {
        assertEquals("", dateStrToDigit("32 декабря 1"))
    ...
    @Tag("Normal")
    fun dateDigitToStr() {
        assertEquals("", dateDigitToStr("31.02.1"))
    ...
    fun bestLongJump() {
        ...
        assertEquals(717, bestLongJump(" % - 717 - %- %-%- "))
    ...
    @Tag("Hard")
    fun bestHighJump() {
        assertEquals(-1, bestHighJump("250 + 224 %+ 298 %- 230 + 232 %%- 304 %+()"))
        assertEquals(304, bestHighJump("250 + 224 %+ 298 %- 230 + 232 %%- 304 %+"))
    ...
    fun plusMinus() {
        ...
        assertEquals(10, plusMinus("2 + 31 - 40 + 13 + 12 - 10 + 2"))
    ...
    fun firstDuplicateIndex() {
       // assertEquals(9, firstDuplicateIndex("Он пошёл в В школу"))
        ...
        assertEquals(40, firstDuplicateIndex("Яблоко упало на ветку с ветки оно упало привет привет землю"))
        assertEquals(9, firstDuplicateIndex("Он пошёл в в школу"))
        assertEquals(-1, firstDuplicateIndex("a m"))
    ...
    @Tag("Hard")
    fun mostExpensive() {
        assertEquals("4_", mostExpensive("4_ 0"))
        assertEquals("_", mostExpensive("_ 1.8"))
        assertEquals("=a", mostExpensive("=a 20.1"))
    ...
    fun fromRoman() {
        ...
        assertEquals(139, fromRoman("IXXCXL"))
